...
class Funciones
{
    ...
    public static $DIRECTORIO_PRINCIPAL = C_RUTA;
        ...
        $html_mensaje = '
                    <html>
                        <head>
                            ...
                            <link rel="stylesheet" href="../util/adminLTE/bootstrap/dist/css/bootstrap.min.css">
                            <!-- Theme style -->
    ...
    public static function imprimeJSON_api($estado, $datos)
    {
        //header("HTTP/1.1 ".$estado." ".$mensaje);
        header("HTTP/1.1 " . $estado);
        header('Content-Type: application/json');
        ...
        echo json_encode($response["datos"]);
    }
    ...
    public static function base64_to_jpeg($base64_string, $output_file)
    {
        ...
        if (fwrite($ifp, base64_decode($base_to_php[1])) === FALSE) {
            return false;
        }
        //fwrite($ifp, base64_decode($base64_string));
        fclose($ifp);
        return true;
        /* $baseFromJS= "data:image/jpeg;base64,".$base64_string;
        $base_to_php = explode(',',$baseFromJS);
        $data = base64_decode($base64_string);
        file_put_contents($output_file,$data);
        return $output_file; */
    }
    public static function limpiarStringImg($string)
    {
        $string = trim($string);
