...
;(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        var TableExport = function (selectors, options, isUpdate) {
            ...
            self.selectors.each(function () {
                ...
                function createObjButton(dataObject, myContent, myClass) {
                    var exportButton = "<button data-fileblob='" + dataObject + "' class='" + bootstrapClass + bootstrapTheme + myClass + "' style='margin-right:5px;'>" + myContent + "</button>";
        ...
        TableExport.prototype = {
            ...
            defaultButton: "btn btn-primary btn-sm",
            /**
             * Bootstrap configuration classes ["base", "theme", "container"].
             * @memberof TableExport.prototype
             */
            /* bootstrap: ["btn", "btn-default", "btn-toolbar"], */
            bootstrap: ["btn", "btn btn-primary", "btn-toolbar"],
            /**
             * Row delimeter
             * @memberof TableExport.prototype
             */
